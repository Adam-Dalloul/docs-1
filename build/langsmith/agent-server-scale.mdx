...
The default value of [`N_JOBS_PER_WORKER`](/langsmith/env-var-self-hosted#n_jobs_per_worker) is 10. You can change this value to scale the maximum number of runs that can be executed at a time by a single queue worker based on the characteristics of your assistant.
